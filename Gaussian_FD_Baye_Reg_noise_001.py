...
np.save('gpfd_BR_DSS_001_tc_1',start_1['z_1'])
np.save('gpfd_BR_DSS_001_tc_1_Z',start_1['pn_1'])
np.save('gpfd_BR_DSS_001_tc_2',start_2['z_1'])
...
np.save('gpfd_BR_DSS_001_nl_1',start_1['z_1'])
np.save('gpfd_BR_DSS_001_nl_1_Z',start_1['pn_1'])
...
np.save('gpfd_BR_DSS_001_lr_1',start_1['z_1'])
np.save('gpfd_BR_DSS_001_lr_1_Z',start_1['pn_1'])
np.save('gpfd_BR_DSS_001_lr_2',start_2['z_1'])
np.save('gpfd_BR_DSS_001_lr_2_Z',start_2['pn_1'])
np.save('gpfd_BR_DSS_001_lr_3',start_3['z_1'])
np.save('gpfd_BR_DSS_001_lr_3_Z',start_3['pn_1'])
...
print("the value of pn_1 in model_2 of twocompart model is",start_2['pn_1'])
np.save('gpfd_BR_MDSS_001_tc_1',start_1['z_1'])
np.save('gpfd_BR_MDSS_001_tc_1_Z',start_1['pn_1'])
np.save('gpfd_BR_MDSS_001_tc_2',start_2['z_1'])
np.save('gpfd_BR_MDSS_001_tc_2_Z',start_2['pn_1'])
...
print("the value of pn_1 in model_2 of nonlinear model is",start_2['pn_1'])
np.save('gpfd_BR_MDSS_001_nl_1',start_1['z_1'])
np.save('gpfd_BR_MDSS_001_nl_1_Z',start_1['pn_1'])
np.save('gpfd_BR_MDSS_001_nl_2',start_2['z_1'])
...
print("the value of pn_1 in model_3 of lorenz model is",start_3['pn_1'])
np.save('gpfd_BR_MDSS_001_lr_1',start_1['z_1'])
np.save('gpfd_BR_MDSS_001_lr_1_Z',start_1['pn_1'])
np.save('gpfd_BR_MDSS_001_lr_2',start_2['z_1'])
np.save('gpfd_BR_MDSS_001_lr_2_Z',start_2['pn_1'])
np.save('gpfd_BR_MDSS_001_lr_3',start_3['z_1'])
np.save('gpfd_BR_MDSS_001_lr_3_Z',start_3['pn_1'])
